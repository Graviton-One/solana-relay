...
async function main() {
  ...
  console.log(data);
  console.log(
    data.tokenAccounts["4hJ6sjwmsvvFag6TKL97yhWiBSDX9BABWoiXgb3EPXxB"].balance
      .toEther()
      .toString()
  );
  console.log(
    data.tokenAccounts["11111111111111111111111111111111"].balance
      .toEther()
      .toString()
  );
  const baseAccount = get(
    data.tokenAccounts,
    `${baseMint}.tokenAccountAddress`
  ); // from token user account
