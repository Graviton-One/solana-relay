...
const {
  closeAccount,
  initializeAccount,
} = require("@project-serum/serum/lib/token-instructions.js");
const anchor = require("@project-serum/anchor");
const { OpenOrders } = require("@project-serum/serum");
const {
  MARKET_STATE_LAYOUT_V2,
} = require("@project-serum/serum/lib/market.js");
...
const LIQUIDITY_POOL_PROGRAM_ID_V4 =
...
function walletFromRaw() {
  const payer = Keypair.fromSecretKey(
    Buffer.from(JSON.parse(process.env.ORACLE_PKEY))
  );
